...
import type { Fish, FishFormData, FishMedia, FishMediaContent } from '@/types/fish';
import { linkUrlImage } from '@/helpers/helper';
    ...
    <div v-if="fishForm !== undefined">
        <CRow>
            <CCol md="12" class="mb-2">
                ...
                <!-- Name -->
                <Field v-model="fishForm.name" :as="CFormInput" placeholder="Enter your name" name="name" />
            ...
            <CCol md="12" class="mb-2">
                ...
                <!-- Description -->
                <Field
                v-model="fishForm.description" :as="CFormTextarea" rows="5" placeholder="Enter your description"
                    name="description" />
            ...
            <CCol md="12" class="mb-2">
                ...
                <input
                id="file" name="media" type="file" accept="image/*" hidden
                ...
                for="file"
                    ...
                    <span class="px-2">Add Photos</span>
                </label>

                <!-- Preview section for images (from DB and newly added) -->
                <template v-if="fishForm.fish_media && fishForm.fish_media.length > 0">
                    <div class="d-flex flex-wrap justify-content-center lg:justify-content-start mt-2">
                        <template v-for="(media, index) in fishForm.fish_media" :key="index">
                            <div
                            v-if="media.status !== 'delete'"
                                ...
                                <div class="w-full h-full">
                                    <img v-if="!media.id" :src="media.url" width="100" height="100" class="rounded">
                                    <img v-else :src="linkUrlImage((media as FishMedia).file.path)" width="100" height="100" class="rounded">
                                </div>
                            </div>
                        </template>
                    </div>
